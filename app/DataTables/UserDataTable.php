    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($dataUser) {
                return '<a href="' . url('admin/dataUser/edit', ['id' => $dataUser->user_id]) . '" class="btn btn-primary mr-2">
                <i class="fa fa-pencil-alt" style="color: white; font-size: 12px;"></i>
                </a>' .
                '<a href="' . url('admin/dataUser/delete', ['id' => $dataUser->user_id]) . '" class="btn btn-danger" 
